...
function resetClientNameLineBreak(clientLabel) {
  ...
  if (textarea) textarea.value = clientLabel || '';
...
function syncInvoicePreview() {
  ...
  if (
    lineBreakTa &&
    String(lineBreakTa.value).trim() &&
    isValidClientNameLineBreakValue(lineBreakTa.value, cnRaw)
  ) {
